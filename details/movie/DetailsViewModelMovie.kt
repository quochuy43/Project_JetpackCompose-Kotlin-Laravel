...
@HiltViewModel
class DetailsViewModelMovie @Inject constructor(
    private val movieListRepository: MovieListRepository,
    private val savedStateHandle: SavedStateHandle
): ViewModel() {
    private val modelId = savedStateHandle.get<Int>("movieID")

    private var _detailsState = MutableStateFlow(DetailStateMovie())
